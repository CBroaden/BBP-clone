...
export default function Header() {
    ...
    return(
        <div className="hero flex flex-col md:h-[70vh] text-outline border-b border-black text-white font-semibold md:flex-row justify-between items-center mx-auto py-4 w-[100vw]">
          ...
          <div className="md:w-[30rem] w-4/5 mx-auto my-auto flex flex-col gap-4">
            <h1 className='font-marker w-full text-center md:text-left text-xl font-black'>Bella&apos;s Balloons & Backdrops</h1>
