...
export default function Header() {
    ...
    return(
        <div className="flex flex-col max-w-6xl md:flex-row justify-between items-center mx-auto w-full bg-gradient-radial from-white from-25% via-fuchsia-200 via-45% to-65% to-white">
